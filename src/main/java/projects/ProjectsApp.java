...
public class ProjectsApp {
	...
	private void updateProjectDetails() {
		...
		Integer difficulty = 
				getIntInput("Enter project difficulty [" + curProject.getDifficulty()+ "]");
		String notes =
	...
	private void selectProject() {
		listProjects();
		Integer projectID = getIntInput("Enter the project ID to select a project: ");
		curProject = null;
...
//		}
		...
		if (Objects.isNull(curProject)) {
			...
			System.out.println("\nYou have selected the project " + curProject + " to work on.");
		}
	}
